...
extern bool             ChangesAreHappened;
...
//*************************************************************************************************
Instance*                   CreateNote(Instrument* instr, bool add, bool preventundo = false);
...
extern Pattern*             CreatePattern(float tk1, float tk2, int tr1, int tr2, PattType pattype);
...
extern void                 ChangesHappened();
extern bool                 CheckSave();
extern void                 AdjustClipboardOffsets();
extern Pattern*             CreateDerivedPattern(Pattern* ptmain, float tk1, float tk2, int tr1, int tr2);
extern void                 ExitOut();
